...
%
% ADDED LV FEEDER WITH R/X = 4.4 and Pc  = 12.4 kW (2 ramais)
...
mpc.bus = [ %% (Pd and Qd are specified in kW & kVAr here, converted to MW & MVAr below)
	1	3	0	0	0	0	1 1.05	0	12.66	1	1	1;
...
% 	25	1	420	200	0	0	1	1	0	12.66	1	1.1	0.9;
 %bus_i	type Pd     Qd	Gs	Bs	area   Vm  Va  baseKV zone Vmax	Vmin	
  	26	1   0.0     0	0	0	1       1	0	0.4	1	1.08	0.92	;
 	27  1   3.1 	0	0	0	1       1	0	0.4	1	1.08	0.92	;
 	28  1   2.1     0   0	0	1       1	0	0.4	1	1.08	0.92	;
 	29 	1   2.5     0	0	0	1       1	0	0.4	1	1.08	0.92	;
  	30  1   2.6     0	0	0	1       1	0	0.4	1	1.08	0.92	;
 	31  1   2.0     0	0	0	1       1	0	0.4	1	1.08	0.92	;
 	32	1   3.1     0	0	0	1       1	0	0.4	1	1.08	0.92	;
 	33  1   2.3     0	0	0	1       1	0	0.4	1	1.08	0.92	;
    34  1   2.6     0	0	0	1       1	0	0.4	1	1.08	0.92	;
%------------------------------------------------------------------   
	35	1	60	25	0	0	1	1	0	12.66	1	1.1	0.9;
	36	1	60	25	0	0	1	1	0	12.66	1	1.1	0.9;
	37	1	60	20	0	0	1	1	0	12.66	1	1.1	0.9;
	38	1	120	70	0	0	1	1	0	12.66	1	1.1	0.9;
	39	1	200	600	0	0	1	1	0	12.66	1	1.1	0.9;
	40	1	150	70	0	0	1	1	0	12.66	1	1.1	0.9;
	41	1	210	100	0	0	1	1	0	12.66	1	1.1	0.9;
	42	1	60	40	0	0	1	1	0	12.66	1	1.1	0.9;
];
...
mpc.branch = [  %% (r and x specified in ohms here, converted to p.u. below)
	...
	6	35	0.2030	0.1034	0	0	0	0	0	0	1	-360	360;
	35	36	0.2842	0.1447	0	0	0	0	0	0	1	-360	360;
    36	37	1.0590	0.9337	0	0	0	0	0	0	1	-360	360;
	37	38	0.8042	0.7006	0	0	0	0	0	0	1	-360	360;
	38	39	0.5075	0.2585	0	0	0	0	0	0	1	-360	360;
	39	40	0.9744	0.9630	0	0	0	0	0	0	1	-360	360;
	40	41	0.3105	0.3619	0	0	0	0	0	0	1	-360	360;
	41	42	0.3410	0.5302	0	0	0	0	0	0	1	-360	360;
%fbus tbus	r           x       b	rateA   rateB   rateC   ratio angle status	angmin	angmax	
 	25	26	0.0000    0.1024    0	0       0       0   0       0       1	-360	360 	;
    26  27	0.0176    0.0040	0	0       0       0	0       0       1	-360	360     ;
	27	28	0.0320    0.0072	0	0       0       0	0       0       1	-360	360     ;
	28	29	0.0208    0.0047	0	0       0       0	0       0       1	-360	360     ;
	29	30	0.0544    0.0123	0	0       0       0	0       0       1	-360	360     ;
    30	31	0.0208    0.0047	0	0       0       0	0       0       1	-360	360     ;
	31	32	0.0448    0.0101	0	0       0       0	0       0   	1	-360	360     ;
	32	33	0.0672    0.0152	0	0       0       0	0       0       1	-360	360     ;
   	33	34	0.0224    0.0051	0	0       0       0	0       0       1	-360	360     ;
];
...
%% Change the buses and branches columns names
[PQ, PV, REF, NONE, BUS_I, BUS_TYPE, PD, QD, GS, BS, BUS_AREA, VM, ...
    VA, BASE_KV, ZONE, VMAX, VMIN, LAM_P, LAM_Q, MU_VMAX, MU_VMIN] = idx_bus;
[F_BUS, T_BUS, BR_R, BR_X, BR_B, RATE_A, RATE_B, RATE_C, ...
    TAP, SHIFT, BR_STATUS, PF, QF, PT, QT, MU_SF, MU_ST, ...
    ANGMIN, ANGMAX, MU_ANGMIN, MU_ANGMAX] = idx_brch;
%% convert voltages from KV to V.
Vbase1 = mpc.bus(1, BASE_KV) * 1e3;      %% 12660 Volts
Vbase2 = mpc.bus(34, BASE_KV)* 1e3;      %% 400 Volts
Sbase = mpc.baseMVA * 1e6;              %% in VA
%% convert branch impedances from Ohms to p.u.
mpc.branch(1:32, [BR_R BR_X]) = mpc.branch(1:32, [BR_R BR_X]) / (Vbase1^2 / Sbase);
mpc.branch(33:41, [BR_R BR_X]) = mpc.branch(33:41, [BR_R BR_X]) / (Vbase2^2 / Sbase);

%% convert loads from kW to MW
mpc.bus(:, [PD, QD]) = mpc.bus(:, [PD, QD]) / 1e3;

results = runpf(mpc);
power = results.branch(1,PF)
